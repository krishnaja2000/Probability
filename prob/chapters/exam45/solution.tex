Let X be the random variable representing the number of times the shooter hits the target. Let n be the total number of times that the shoter fires.Then
\begin{align}
X \epsilon \{0,1,2....n\}
\end{align}
